...
A 1990s Motif-styled Network Operations Center (NOC) dashboard built for the StudentHPC campus network. This project utilizes a Java 8 Applet compiled to WebAssembly (via CheerpJ) to render a dynamic, hardware-accelerated BGP topology map at a strict 17 FPS.
